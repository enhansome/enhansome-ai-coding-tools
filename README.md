...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,040 | 🐛 347 | 📅 2026-04-25.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,750 | 🐛 99 | 🌐 Python | 📅 2026-08-28** – Open-source AI agent for PR reviews with actionable insights.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,031 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,427 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,513 | 🐛 167 | 🌐 Rust | 📅 2026-08-28** – Git extension that tracks AI-generated code and the prompts behind each line.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,073 | 🐛 1,258 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 825 | 🐛 83 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
