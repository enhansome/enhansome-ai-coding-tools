...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,430 | 🐛 105 | 📅 2026-08-21
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,754 | 🐛 870 | 🌐 TypeScript | 📅 2026-08-30** – Google's terminal coding agent powered by Gemini.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,208 | 🐛 9 | 🌐 Rust | 📅 2026-08-20** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 67,185 | 🐛 1,152 | 🌐 TypeScript | 📅 2026-08-30** – VS Code extension with full file system access and autonomous coding.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 60,703 | 🐛 1,000 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 53,704 | 🐛 234 | 🌐 Rust | 📅 2026-08-29** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,610 | 🐛 1,838 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,173 | 🐛 83 | 🌐 Python | 📅 2026-08-24** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[Smol Developer](https://github.com/smol-ai/developer) ⭐ 12,187 | 🐛 86 | 🌐 Python | 📅 2024-04-07** – Lightweight AI coding agent for rapid prototyping.
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 8,994 | 🐛 63 | 🌐 Python | 📅 2026-08-30** – Multi-agent framework with 100+ LLM support and MCP integration.
...
* **[brood-box](https://github.com/stacklok/brood-box) ⭐ 64 | 🐛 13 | 🌐 Go | 📅 2026-08-30** – Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation, egress control, and MCP authorization.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,754 | 🐛 870 | 🌐 TypeScript | 📅 2026-08-30** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,610 | 🐛 1,838 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,073 | 🐛 1,067 | 🌐 Go | 📅 2026-08-28** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[ShellGPT](https://github.com/TheR1D/shell_gpt) ⭐ 12,265 | 🐛 120 | 🌐 Python | 📅 2026-07-02** – ChatGPT integration for shell command generation and system administration.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 76,369 | 🐛 134 | 🌐 Python | 📅 2026-08-14** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,827 | 🐛 134 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,117 | 🐛 334 | 🌐 TypeScript | 📅 2026-08-30** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,769 | 🐛 62 | 🌐 Python | 📅 2026-08-30** – Open-source AI agent for PR reviews with actionable insights.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,270 | 🐛 169 | 🌐 Python | 📅 2026-08-30** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,821 | 🐛 112 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,037 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,431 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-29** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,516 | 🐛 168 | 🌐 Rust | 📅 2026-08-28** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[git-parsec](https://github.com/erishforG/git-parsec) ⭐ 15 | 🐛 18 | 🌐 Rust | 📅 2026-08-30** – Git worktree lifecycle manager that gives each AI agent an isolated workspace tied to issue tickets (Jira, GitHub Issues, GitLab), avoiding index.lock conflicts in parallel workflows.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 57,611 | 🐛 4,901 | 🌐 Python | 📅 2026-08-30** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,518 | 🐛 265 | 🌐 C# | 📅 2026-08-27** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,678 | 🐛 552 | 🌐 TypeScript | 📅 2026-08-30** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,792 | 🐛 212 | 🌐 C++ | 📅 2026-08-26** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[Bearer CLI](https://github.com/Bearer/bearer) ⭐ 2,740 | 🐛 17 | 🌐 Go | 📅 2026-08-24** – Open-source static security analysis for sensitive data exposure and GDPR/PCI compliance.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,091 | 🐛 1,262 | 📅 2025-12-31** – General AI tools for various applications.
