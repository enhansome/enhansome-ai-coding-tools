...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,231 | 🐛 106 | 📅 2026-09-02
...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,087 | 🐛 127 | 📅 2026-09-18.
...
* **[Cate](https://github.com/0-AI-UG/cate) ⭐ 2,149 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-20** – Infinite zoomable canvas IDE where editor, terminal, browser, and Claude Code agent panels float spatially, like Figma or Miro but for coding.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,100 | 🐛 844 | 🌐 TypeScript | 📅 2026-09-20** – Google's terminal coding agent powered by Gemini.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 68,882 | 🐛 1,394 | 🌐 TypeScript | 📅 2026-09-20** – VS Code extension with full file system access and autonomous coding.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,393 | 🐛 2 | 🌐 Rust | 📅 2026-09-20** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 61,079 | 🐛 1,087 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 54,501 | 🐛 401 | 🌐 Rust | 📅 2026-09-19** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 49,085 | 🐛 1,884 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[Dcode](https://github.com/langchain-ai/deepagents) ⭐ 29,602 | 🐛 200 | 🌐 Python | 📅 2026-09-20** – The coding agent you own. Open-source, model-agnostic, and built by LangChain to give you maximum control over your software development lifecycle.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,371 | 🐛 116 | 🌐 Python | 📅 2026-09-14** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,080 | 🐛 94 | 🌐 Python | 📅 2026-09-18** – Multi-agent framework with 100+ LLM support and MCP integration.
* **[Maestro](https://github.com/RunMaestro/Maestro) ⭐ 3,355 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-20** – Open-source desktop command center for running multiple AI coding agents (Claude Code, Codex, Gemini CLI, etc.) in parallel, with Cue event automation, Auto Run playbooks, Group Chat across local and remote agents, and a maestro-cli that agents can drive themselves.
* **[Atomic Agent](https://github.com/AtomicBot-ai/atomic-agent) ⭐ 2,524 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-17** – Local-first coding agent that runs open-weight models entirely on your machine via a llama.cpp fork. 56 built-in tools (browser, filesystem, git, memory, vision), MCP support, and a five-layer memory system. No account or API key required.
* **[BitFun](https://github.com/GCWing/BitFun) ⭐ 2,303 | 🐛 62 | 🌐 Rust | 📅 2026-09-20** – Cross-platform desktop coding agent built on a Rust runtime, with Git-aware workflows, Deep Review, MCP/Skills/Hooks, remote workspaces, and state-bound Mini Apps.
* **[Orkas](https://github.com/Orkas-AI/Orkas) ⭐ 2,099 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-20** – Open-source local-first desktop workspace that runs Claude Code, Codex CLI, OpenCode, Cline, and built-in agents in parallel with shared files and approval controls. [Website](https://orkas.ai?source=gh-codingtools)
* **[SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 677 | 🐛 20 | 🌐 TypeScript | 📅 2026-06-30** – Self-hosted multi-agent runtime with MCP client and server support, 23+ LLM providers, persistent memory, skills, schedules, and messaging connectors. Electron desktop app, CLI, and Docker.
...
* **[OpenCode Mobile](https://github.com/dzianisv/opencode-mobile) ⭐ 179 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-20** – Open-source (MIT) Android client for the OpenCode coding agent; run AI coding sessions from your phone against your own self-hosted server with bring-your-own keys.
* **[LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 150 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-20** – Local GUI orchestrator for long-running, high-correctness AI software delivery — LLM councils plan it, Ralph loops perfect it, OpenCode worktrees ship it.
* **[Ordewell](https://github.com/ordewell/ordewell) ⭐ 132 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-20** – Plan-first CLI/TUI orchestrator that turns one goal into an ordered plan of coding-agent tasks, each with its own runner (Claude Code, Codex, OpenCode), model, thinking effort and mode — editable before execution, run as one agent session per task, and marked done only when its own completion marker appears in the output. Apache-2.0, free, no paid tier.
...
* **[brood-box](https://github.com/stacklok/brood-box) ⭐ 72 | 🐛 5 | 🌐 Go | 📅 2026-09-18** – Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation, egress control, and MCP authorization.
...
* **[intentic](https://github.com/intentic/intentic) ⭐ 44 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20** – Self-hosted workspace that runs Claude Code, Codex, OpenCode, and Gemini CLI agents in parallel, each in its own Docker container and git worktree on hardware you own. Browser and mobile UI, terminals that survive disconnects, an editable sandbox Dockerfile, and per-file, per-hunk diff review before changes land. MIT, TypeScript.
* **[Superagent](https://github.com/pungme/superagent-desktop) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20** – Open-source macOS desktop app giving Claude Code and Codex a real browser to drive, an iOS Simulator to install and screenshot apps in, and a phone companion app for remote monitoring.
...
* **[Emdash Skills](https://github.com/megabytespace/claude-skills) ⭐ 21 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-20** – 14-category autonomous product-building OS with 18 specialized agents that turn one-line prompts into deployed products on Cloudflare Workers.
* **[Claude Skills](https://github.com/heymegabyte/claude-skills) ⭐ 21 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-20** – 14-category autonomous product-building OS bundling 18 specialized agents (architect, test-writer, deploy-verifier, security-reviewer, visual-qa, performance-profiler, accessibility-auditor, content-writer, completeness-checker, dependency-auditor, migration-agent, incident-responder, computer-use-operator, meta-orchestrator, seo-auditor, cost-estimator, changelog-generator, code-simplifier). One config drops into Claude Code, Codex, Cursor, Copilot, Gemini CLI, Windsurf, opencode, Cline, and Aider. One-line prompts deploy production sites with hard quality gates (Playwright at 6 breakpoints, axe-core 0 violations, Lighthouse a11y >=95, AI vision >=8/10).
...
* **[Mirafold](https://github.com/mirafold/mirafold) ⭐ 16 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-20** – Browser UI for Claude Code, Codex, and Gemini CLI where the agent renders live charts, diffs, and task lists as it works, with mission control across multiple sessions and E2E-encrypted phone pairing (self-hostable relay). Open source, local-first.
* **[OpenMagic](https://github.com/Kalmuraee/OpenMagic) ⭐ 15 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-19** – AI-powered coding toolbar for any web app. Injects a floating toolbar via reverse proxy, captures element context, previews diffs, and applies approved changes in real time.
...
* **[cc-code](https://github.com/cc-claws/cc-code) ⭐ 4 | 🐛 29 | 🌐 Rust | 📅 2026-09-20** – Open-source Rust terminal coding agent, Claude Code compatible. Runs DeepSeek, MiMo, GLM with \~50MB memory and 95-99% prompt cache hit rate.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,100 | 🐛 844 | 🌐 TypeScript | 📅 2026-09-20** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 49,085 | 🐛 1,884 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,343 | 🐛 1,088 | 🌐 Go | 📅 2026-09-19** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[ShellGPT](https://github.com/TheR1D/shell_gpt) ⭐ 12,285 | 🐛 121 | 🌐 Python | 📅 2026-07-02** – ChatGPT integration for shell command generation and system administration.
...
* **[fx](https://github.com/vercel-labs/fx) ⭐ 3,083 | 🐛 235 | 🌐 Zig | 📅 2026-09-20** – Tiny, open-source coding agent harness by Vercel Labs, written in Zig; model-agnostic, Unix-shell-like output, and embeddable in agent sandboxes.
* **[Webcmd](https://github.com/agentrhq/webcmd) ⭐ 2,243 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-11** – Self-learning browser infrastructure CLI for coding agents; learns a site once, then reuses it as deterministic per-site commands.
* **[Vox Director](https://github.com/Alisa0808/vox-director) ⭐ 1,981 | 🐛 3 | 🌐 Python | 📅 2026-08-11** – Agent skill that turns one topic into a finished Vox-style paper-collage explainer/ad video (script, collage art, motion, voice-over, music, captions); runs on Atlas Cloud + ffmpeg. Works with Claude Code, Codex & any SKILL.md agent.
* **[patina](https://github.com/devswha/patina) ⭐ 358 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-20** – Multilingual CLI and agent skill that audits and rewrites AI-sounding writing patterns while preserving claims, numbers, polarity, and causation.
* **[AgentBridge](https://github.com/raysonmeng/agent-bridge) ⭐ 352 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-20** – Local MIT CLI that keeps Claude Code and Codex as live peers in one session for mid-turn review and quota-boundary handoff.
* **[VibePod](https://github.com/VibePod/vibepod-cli) ⭐ 166 | 🐛 26 | 🌐 Python | 📅 2026-09-17** – Unified CLI for running Claude Code, Codex, OpenCode, Pi, and other AI coding agents in isolated Docker or Podman containers, with local metrics and an analytics dashboard.
* **[oh-my-kimi](https://github.com/dmae97/oh-my-kimi) ⭐ 144 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-20** – Multi-agent orchestration harness for Kimi K2.6. Parallel coding teams in git worktrees, DAG scheduling, live quality gates, terminal HUD, and MCP skill-hooks.
...
* **[CommitLore](https://github.com/MongLong0214/commitlore) ⭐ 18 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20** – Git-native decision memory that stores constraints and ruled-out alternatives as git trailers and notes, giving coding agents only the guidance still in force for the file being edited.
...
* **[cc-code](https://github.com/cc-claws/cc-code) ⭐ 4 | 🐛 29 | 🌐 Rust | 📅 2026-09-20** – Rust-native terminal agent, Claude Code `.claude/` config compatible. Multi-model (DeepSeek/MiMo/GLM), \~50MB memory.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 79,405 | 🐛 146 | 🌐 Python | 📅 2026-09-09** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,893 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
* **[Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,647 | 🐛 62 | 🌐 Go | 📅 2025-10-03** – AI tool for planning and generating code from text prompts in the terminal.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,432 | 🐛 287 | 🌐 TypeScript | 📅 2026-09-20** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
* **[StyleSeed](https://github.com/bitjaru/styleseed) ⭐ 960 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-18** – Design engine that makes Claude Code & Cursor produce professional UI — 33 components, 69 design rules, 8 brand skins, and a named framer-motion motion system.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 13,084 | 🐛 44 | 🌐 Python | 📅 2026-09-20** – Open-source AI agent for PR reviews with actionable insights.
* **[Sweep](https://github.com/sweepai/sweep) ⭐ 7,711 | 🐛 753 | 🌐 Jupyter Notebook | 📅 2025-09-18** – AI agent for automating PR reviews and fixes.
* **[brooks-lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,487 | 🐛 0 | 🌐 HTML | 📅 2026-09-20** – Claude Code plugin that reviews code against twelve classic engineering books, citing each finding to its source and scoring codebase health 0–100.
* **[OrcaCode Review](https://github.com/Continuum-AI-Corp/orca-code-review) ⭐ 165 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-20** – GitHub Action for AI pull request review that posts findings inline on the affected lines and blocks merges on critical severity.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,692 | 🐛 198 | 🌐 Python | 📅 2026-09-20** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
* **[README-AI](https://github.com/eli64s/readme-ai) ⭐ 2,989 | 🐛 57 | 🌐 Python | 📅 2026-09-16** – AI tool for creating professional README files automatically.
...
* **[SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 695 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-30** – Local-first RAG knowledge vault. Compiles raw sources into a durable markdown wiki with a knowledge graph and hybrid SQLite FTS plus embeddings. Built-in MCP server for Claude Code, Codex, and OpenCode.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,842 | 🐛 112 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[DeepSeek Coder](https://github.com/deepseek-ai/DeepSeek-Coder-V2) ⭐ 7,013 | 🐛 79 | 📅 2025-11-11** – High-performance open-source coding model; popular for cost-efficient AI coding via API.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,087 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,835 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-19** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,835 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-19** – Open-source (MIT) Claude Code skills for SEO, GEO, Google Ads, and Meta Ads (\~2.9k stars). Connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP to run audits, manage campaigns, optimize meta tags and schema markup, and research keywords directly from Claude Code.

* **[Vibe-Coding Prompt Template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 3,088 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10** – Five-step planning workflow (deep research, PRD, tech design, `AGENTS.md`, build) with an `npx vibeworkflow` CLI that interviews you and writes the docs your coding agent reads. Free and MIT licensed.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,753 | 🐛 227 | 🌐 Rust | 📅 2026-09-15** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[PM Skills](https://github.com/mohitagw15856/pm-claude-skills) ⭐ 1,383 | 🐛 10 | 🌐 HTML | 📅 2026-09-20** – Open-source (MIT) library of 1,153 Agent Skills as plain-markdown `SKILL.md` files, covering PRDs, incident postmortems, code review checklists, RFCs, and 35 professions. Installs into Claude Code, Cursor, Windsurf, Zed and 10 more tools with one command, ships an MCP server, and runs free in a browser playground. Install: `npx pm-claude-skills add`.
...
* **[Claudexor](https://github.com/razzant/claudexor) ⭐ 475 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-20** – Local-first control plane for Claude Code, Codex, Cursor, and OpenCode with quota-aware profiles, cross-model review, and best-of-N runs.

* **[ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 417 | 🐛 63 | 🌐 Python | 📅 2026-09-20** – Self-hosted dashboard that reads the session logs coding agents already write on disk (Claude Code, Codex, Cursor, Aider, Goose, OpenClaw and others), so there is no SDK and nothing sits in the request path. Shows sessions, tool calls, tokens and cache-aware cost per session and per model. MIT core, `pip install clawmetry`. [Website](https://clawmetry.com)

* **[harmony-next.skills](https://github.com/linhay/harmony-next.skills) ⭐ 352 | 🐛 0 | 🌐 Python | 📅 2026-09-20** – Open-source HarmonyOS NEXT workflow toolkit for AI coding agents. Provides offline ArkTS/ArkUI/API references, DevEco/HDC/Emulator automation, UI/UX audit helpers, and smoke-test templates for mobile app development.
...
* **[AgentPlane](https://github.com/basilisk-labs/agentplane) ⭐ 77 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-20** – Local-first, Git-native CLI harness for repo-local coding-agent work, recording task state, accepted plans, verification evidence, and finish records inside the repository.
...
* **[ChatCrystal](https://github.com/ZengLiangYi/ChatCrystal) ⭐ 58 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20** – Local-first memory loop for AI coding conversations, with MCP search, task recall, writeback, and installable Agent Skills.
...
* **[Wolfpack](https://github.com/almogdepaz/wolfpack) ⭐ 39 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-20** – Self-hosted browser and mobile control center for persistent AI coding-agent and shell sessions across machines, with direct private access over Tailscale.
...
* **[DSH Studio](https://github.com/Moresyl/dsh-studio) ⭐ 26 | 🐛 1 | 🌐 Rust | 📅 2026-09-15** – Open-source cross-platform desktop host for installing, running, health-checking, and supervising DeepSeek Harness locally.

* **[Data Olympus](https://github.com/knaisoma/data-olympus) ⭐ 25 | 🐛 19 | 🌐 Python | 📅 2026-09-20** – Governed project knowledge for AI coding agents via MCP. Agents can propose learnings, humans promote accepted guidance, and retrieval filters out expired or superseded rules before they enter future coding sessions.
...
* **[Unship](https://github.com/mbenhard/unship) ⭐ 21 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-16** – Open-source local picker for comparing AI agent-made UI variants in a running app, then keeping one and cleaning up the rest.
...
* **[ControlKeel](https://github.com/aryaminus/controlkeel) ⭐ 11 | 🐛 18 | 🌐 Elixir | 📅 2026-09-20** – Governance/control plane for AI coding agents. Validates risky actions, records findings, gates approvals, tracks budgets/providers, and creates proof bundles across Claude Code, Codex CLI, OpenCode, Cursor, and other hosts.
...
* **[AllPet](https://github.com/haverainlilili/all-pet) ⭐ 3 | 🐛 0 | 🌐 Swift | 📅 2026-09-20** – Open-source (MIT) desktop pet that watches your AI coding agents (Codex, Claude Code / Desktop, DeepSeek Harness, Grok) from local session logs — no accounts or API keys — and wakes the original session on click. Cross-platform `status`/`watch` CLI.
...
* **[Agent Operator Score](https://github.com/MongLong0214/agent-operator-score) ⭐ 0 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-20** – Local-first CLI (`aos`) that scores how well you operate Claude Code, Codex, and Grok CLI from your own session transcripts, plus a controlled-run assessment suite with a hidden verifier. No model calls in review mode; nothing leaves your disk.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 59,239 | 🐛 5,208 | 🌐 Python | 📅 2026-09-20** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,581 | 🐛 311 | 🌐 C# | 📅 2026-09-19** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,313 | 🐛 637 | 🌐 TypeScript | 📅 2026-09-20** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
* **[AIWG](https://github.com/jmagly/aiwg) ⭐ 211 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-20** – Deploys reusable agents, skills, and governed workflows across multiple AI coding platforms.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 26,004 | 🐛 211 | 🌐 C++ | 📅 2026-09-16** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[token-optimizer](https://github.com/alexgreensh/token-optimizer) ⭐ 2,331 | 🐛 0 | 🌐 Python | 📅 2026-09-17** – Context and token-cost optimizer for AI coding agents. Finds wasted "ghost tokens," survives compaction, and reduces context-quality decay, with native plugins for Claude Code, Codex, OpenCode, and OpenClaw.
* **[KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20** – Open-source multi-cluster Kubernetes dashboard with an MCP server (kc-agent) enabling AI coding agents to query and manage clusters via natural language.
...
* **[repo-forensics](https://github.com/alexgreensh/repo-forensics) ⭐ 177 | 🐛 7 | 🌐 Python | 📅 2026-09-13** – Offline security scanner for AI-agent repos, skills, plugins, and MCP servers; detects prompt injection, credential theft, and manifest drift.
* **[gate.cat](https://github.com/BGMLAI/gate.cat) ⭐ 2 | 🐛 5 | 🌐 Python | 📅 2026-09-20** – Deterministic, fail-closed action veto for AI coding agents that blocks irreversible shell commands (rm -rf, DROP TABLE, terraform destroy) and secret exfiltration before they run, with no LLM in the veto path. Works as a Claude Code hook, a gated shell for any CLI agent, or a local OpenAI-API proxy.
...
* **[Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,152 | 🐛 64 | 🌐 Rust | 📅 2026-09-20** – Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* **[Entroly](https://github.com/juyterman1000/entroly) ⭐ 465 | 🐛 2 | 🌐 Python | 📅 2026-09-20** – Local-first MCP server for explicit-budget context selection, content-addressed exact recovery, and auditable Context Receipts. Apache-2.0.
...
* **[terminal-mcp](https://github.com/elleryfamilia/terminal-mcp) ⭐ 139 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21** – MCP server that gives AI assistants a shared view of your terminal session. Debug CLIs and TUI apps in real-time or let agents drive terminal-based tools autonomously. Works with Claude Code, Codex, Cursor, opencode, and Copilot.
* **[agent-lsp](https://github.com/blackwell-systems/agent-lsp) ⭐ 130 | 🐛 2 | 🌐 Go | 📅 2026-09-20** – MCP server that gives AI coding agents language server intelligence (go-to-definition, find-references, diagnostics, refactoring, speculative execution) across 30 languages. 56 tools, 22 agent skills, single Go binary.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,248 | 🐛 1,358 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 838 | 🐛 98 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
