...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,422 | 🐛 106 | 📅 2026-09-02
...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,102 | 🐛 161 | 📅 2026-09-18.
...
* **[Cate](https://github.com/0-AI-UG/cate) ⭐ 2,151 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23** – Infinite zoomable canvas IDE where editor, terminal, browser, and Claude Code agent panels float spatially, like Figma or Miro but for coding.
* **[BBARIT](https://github.com/bbarit/terminal) ⭐ 37 | 🐛 5 | 📅 2026-08-21** – Free native all-in-one AI coding IDE (Tauri/Rust) with multi-agent terminals, office editing, and an embedded agent-driven browser; bring any model or run locally with Ollama.
* **[Harness Desktop](https://github.com/baiyuscc13724-max/deepseek-harness-desktop) ⭐ 10 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-08** – Open-source Windows client for the official DeepSeek Harness Web UI, with a Simplified Chinese installer, portable build, verified updates, and persistent themes.
* **[Coworker](https://github.com/leonjackman/coworker) ⭐ 0 | 🐛 8 | 🌐 Python | 📅 2026-09-23** – Local-first AI coding assistant desktop app with MCP integration, multi-provider AI support, and skills marketplace. Built with Electron, React, and LangGraph. MIT licensed.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,138 | 🐛 830 | 🌐 TypeScript | 📅 2026-09-23** – Google's terminal coding agent powered by Gemini.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 69,170 | 🐛 1,441 | 🌐 TypeScript | 📅 2026-09-23** – VS Code extension with full file system access and autonomous coding.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,416 | 🐛 1 | 🌐 Rust | 📅 2026-09-23** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 61,127 | 🐛 1,094 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 54,593 | 🐛 396 | 🌐 Rust | 📅 2026-09-23** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 49,136 | 🐛 1,885 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[Dcode](https://github.com/langchain-ai/deepagents) ⭐ 29,703 | 🐛 179 | 🌐 Python | 📅 2026-09-23** – The coding agent you own. Open-source, model-agnostic, and built by LangChain to give you maximum control over your software development lifecycle.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,390 | 🐛 119 | 🌐 Python | 📅 2026-09-21** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[Smol Developer](https://github.com/smol-ai/developer) ⭐ 12,189 | 🐛 87 | 🌐 Python | 📅 2024-04-07** – Lightweight AI coding agent for rapid prototyping.
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,083 | 🐛 120 | 🌐 Python | 📅 2026-09-23** – Multi-agent framework with 100+ LLM support and MCP integration.
* **[Maestro](https://github.com/RunMaestro/Maestro) ⭐ 3,357 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-23** – Open-source desktop command center for running multiple AI coding agents (Claude Code, Codex, Gemini CLI, etc.) in parallel, with Cue event automation, Auto Run playbooks, Group Chat across local and remote agents, and a maestro-cli that agents can drive themselves.
* **[Atomic Agent](https://github.com/AtomicBot-ai/atomic-agent) ⭐ 2,545 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-23** – Local-first coding agent that runs open-weight models entirely on your machine via a llama.cpp fork. 56 built-in tools (browser, filesystem, git, memory, vision), MCP support, and a five-layer memory system. No account or API key required.
* **[BitFun](https://github.com/GCWing/BitFun) ⭐ 2,317 | 🐛 63 | 🌐 Rust | 📅 2026-09-23** – Cross-platform desktop coding agent built on a Rust runtime, with Git-aware workflows, Deep Review, MCP/Skills/Hooks, remote workspaces, and state-bound Mini Apps.
* **[Orkas](https://github.com/Orkas-AI/Orkas) ⭐ 2,113 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-23** – Open-source local-first desktop workspace that runs Claude Code, Codex CLI, OpenCode, Cline, and built-in agents in parallel with shared files and approval controls. [Website](https://orkas.ai?source=gh-codingtools)
* **[SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 680 | 🐛 20 | 🌐 TypeScript | 📅 2026-06-30** – Self-hosted multi-agent runtime with MCP client and server support, 23+ LLM providers, persistent memory, skills, schedules, and messaging connectors. Electron desktop app, CLI, and Docker.
* **[agentty](https://github.com/1ay1/agentty) ⭐ 604 | 🐛 2 | 🌐 C++ | 📅 2026-09-23** – Native C++26 terminal coding agent and drop-in claude-code alternative. Single static binary, sub-millisecond cold start, sandboxed by default, and model-agnostic (Claude, OpenAI, Groq, OpenRouter, Ollama). Runs inside Zed over ACP and drives air-gapped hosts over SSH. MIT.
...
* **[OpenCode Mobile](https://github.com/dzianisv/opencode-mobile) ⭐ 184 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-20** – Open-source (MIT) Android client for the OpenCode coding agent; run AI coding sessions from your phone against your own self-hosted server with bring-your-own keys.
* **[LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 153 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23** – Local GUI orchestrator for long-running, high-correctness AI software delivery — LLM councils plan it, Ralph loops perfect it, OpenCode worktrees ship it.
* **[Ordewell](https://github.com/ordewell/ordewell) ⭐ 142 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23** – Plan-first CLI/TUI orchestrator that turns one goal into an ordered plan of coding-agent tasks, each with its own runner (Claude Code, Codex, OpenCode), model, thinking effort and mode — editable before execution, run as one agent session per task, and marked done only when its own completion marker appears in the output. Apache-2.0, free, no paid tier.
* **[DvalinCode](https://github.com/arthurpanhku/dvalincode) ⭐ 118 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-22** – Provider-neutral, local-first CLI coding agent (Chat/Cowork/Code modes) built for governance: org policy engine, enforced network egress, and a verifiable hash-chained audit trail. Works with any OpenAI-compatible endpoint (DeepSeek, OpenAI, Claude via OpenRouter, Groq, Ollama). Zero runtime deps. MIT.
* **[Weco (weco-cli)](https://github.com/WecoAI/weco-cli) ⭐ 106 | 🐛 5 | 🌐 Python | 📅 2026-09-02** – Autoresearch CLI that optimizes code (GPU kernels, ML models, prompts) by editing a file, running your eval, and keeping changes only when the metric improves.
...
* **[NarraNexus](https://github.com/NetMindAI-Open/NarraNexus) ⭐ 85 | 🐛 57 | 🌐 Python | 📅 2026-09-14** – Open-source AI agent team workspace with a ready-to-run team of agents that remember, collaborate, and use tools, supporting multi-agent coding workflows.
* **[brood-box](https://github.com/stacklok/brood-box) ⭐ 74 | 🐛 9 | 🌐 Go | 📅 2026-09-23** – Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation, egress control, and MCP authorization.
* **[Keen Code](https://github.com/mochow13/keen-code) ⭐ 66 | 🐛 10 | 🌐 Go | 📅 2026-09-22** – An open-source, context-aware terminal-based coding agent written in Go. Supports multiple providers, MCPs, subagents, Agent Skills, controllable tool output retention, hashline edits, and more.
...
* **[AgentTier](https://github.com/agenttier/agenttier) ⭐ 55 | 🐛 25 | 🌐 Go | 📅 2026-09-21** – Self-hosted Kubernetes-native sandbox runtime for AI coding agents (Claude Code, OpenHands, LangGraph). Same Sandbox CRD provisions a Pod + PVC + default-deny NetworkPolicy with optional gVisor isolation, hierarchical governance, and a streaming SSE invoke API.
...
* **[intentic](https://github.com/intentic/intentic) ⭐ 46 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23** – Self-hosted workspace that runs Claude Code, Codex, OpenCode, and Gemini CLI agents in parallel, each in its own Docker container and git worktree on hardware you own. Browser and mobile UI, terminals that survive disconnects, an editable sandbox Dockerfile, and per-file, per-hunk diff review before changes land. MIT, TypeScript.
* **[Superagent](https://github.com/pungme/superagent-desktop) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23** – Open-source macOS desktop app giving Claude Code and Codex a real browser to drive, an iOS Simulator to install and screenshot apps in, and a phone companion app for remote monitoring.
* **[Emdash Skills](https://github.com/megabytespace/claude-skills) ⭐ 22 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22** – 14-category autonomous product-building OS with 18 specialized agents that turn one-line prompts into deployed products on Cloudflare Workers.
* **[Claude Skills](https://github.com/heymegabyte/claude-skills) ⭐ 22 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22** – 14-category autonomous product-building OS bundling 18 specialized agents (architect, test-writer, deploy-verifier, security-reviewer, visual-qa, performance-profiler, accessibility-auditor, content-writer, completeness-checker, dependency-auditor, migration-agent, incident-responder, computer-use-operator, meta-orchestrator, seo-auditor, cost-estimator, changelog-generator, code-simplifier). One config drops into Claude Code, Codex, Cursor, Copilot, Gemini CLI, Windsurf, opencode, Cline, and Aider. One-line prompts deploy production sites with hard quality gates (Playwright at 6 breakpoints, axe-core 0 violations, Lighthouse a11y >=95, AI vision >=8/10).
...
* **[cc-code](https://github.com/cc-claws/cc-code) ⭐ 5 | 🐛 32 | 🌐 Rust | 📅 2026-09-23** – Open-source Rust terminal coding agent, Claude Code compatible. Runs DeepSeek, MiMo, GLM with \~50MB memory and 95-99% prompt cache hit rate.
* **[issue-orchestrator](https://github.com/BruceBGordon/issue-orchestrator) ⭐ 5 | 🐛 187 | 🌐 Python | 📅 2026-09-23** – Open-source orchestrator that runs Claude, Codex, and Gemini agents on GitHub issues in isolated worktrees, treating agent output as a claim, not authority: nothing advances until validation and a reviewer agent pass, with crash recovery and human merge authority.
...
* **[Sillage](https://github.com/MarlBurroW/sillage) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23** – Self-hosted, MIT-licensed, mobile-first web UI that drives the native Claude Code and Codex CLIs on your own machine, with server-side sessions, full-text search, an IDE panel, an MCP board the agents read, and an installable PWA. Single Docker container.
* **[Browy](https://github.com/BrowyHQ/browy) ⭐ 4 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-23** – Open-source AI agent for Chrome that drives real browser tabs through chat, with a built-in DevTools CLI terminal for power users. Powered by the GitHub Copilot SDK.
...
* **[Coworker](https://github.com/leonjackman/coworker) ⭐ 0 | 🐛 8 | 🌐 Python | 📅 2026-09-23** – Local-first AI coding agent desktop app with long-term memory, human-in-the-loop, web search, and 11-language i18n. MIT licensed, 396+ commits.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,138 | 🐛 830 | 🌐 TypeScript | 📅 2026-09-23** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 49,136 | 🐛 1,885 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,383 | 🐛 1,090 | 🌐 Go | 📅 2026-09-23** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[AICommits](https://github.com/Nutlope/aicommits) ⭐ 9,100 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-05** – AI-powered meaningful git commit message generation.
* **[fx](https://github.com/vercel-labs/fx) ⭐ 3,142 | 🐛 233 | 🌐 Zig | 📅 2026-09-23** – Tiny, open-source coding agent harness by Vercel Labs, written in Zig; model-agnostic, Unix-shell-like output, and embeddable in agent sandboxes.
* **[Webcmd](https://github.com/agentrhq/webcmd) ⭐ 2,279 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-11** – Self-learning browser infrastructure CLI for coding agents; learns a site once, then reuses it as deterministic per-site commands.
* **[Vox Director](https://github.com/Alisa0808/vox-director) ⭐ 2,015 | 🐛 3 | 🌐 Python | 📅 2026-08-11** – Agent skill that turns one topic into a finished Vox-style paper-collage explainer/ad video (script, collage art, motion, voice-over, music, captions); runs on Atlas Cloud + ffmpeg. Works with Claude Code, Codex & any SKILL.md agent.
...
* **[AgentBridge](https://github.com/raysonmeng/agent-bridge) ⭐ 358 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-23** – Local MIT CLI that keeps Claude Code and Codex as live peers in one session for mid-turn review and quota-boundary handoff.
* **[VibePod](https://github.com/VibePod/vibepod-cli) ⭐ 167 | 🐛 27 | 🌐 Python | 📅 2026-09-23** – Unified CLI for running Claude Code, Codex, OpenCode, Pi, and other AI coding agents in isolated Docker or Podman containers, with local metrics and an analytics dashboard.
* **[Vibe Creating](https://github.com/Alisa0808/vibe-creating-skill) ⭐ 145 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-17** – Open-source bilingual (EN/中文) Claude Agent Skill that rewrites a rough idea or over-specified shot script into a model-ready text-to-video prompt (Seedance 2.0, Kling, Veo, Hailuo, Wan, Vidu). Install via `npx`. Free, MIT.
* **[oh-my-kimi](https://github.com/dmae97/oh-my-kimi) ⭐ 144 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23** – Multi-agent orchestration harness for Kimi K2.6. Parallel coding teams in git worktrees, DAG scheduling, live quality gates, terminal HUD, and MCP skill-hooks.
* **[RoleCraft](https://github.com/rolecraft-sh/rolecraft) ⭐ 82 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-18** – Zero-dependency CLI to install AI agent skills as roles & behaviors from any source. Works with 86 coding agents.
* **[Crab Code](https://github.com/crabforge/crab-code) ⭐ 76 | 🐛 1 | 🌐 Rust | 📅 2026-09-22** – Rust-native agentic coding CLI supporting any LLM provider with multi-entry-point architecture (CLI/IDE/Web/Desktop). Apache-2.0.
...
* **[AI Badger](https://github.com/PVRLabs/aibadger) ⭐ 41 | 🐛 2 | 🌐 Go | 📅 2026-09-23** – Local-first CLI for extracting clean, relevant codebase context to paste into any AI coding assistant.
* **[Loadout](https://github.com/elleryfamilia/loadout) ⭐ 31 | 🐛 0 | 🌐 Rust | 📅 2026-09-21** – Adaptive context engine for AI coding agents. Detects your stack and equips the right context when you launch `load claude`, `load codex`, `load cursor`. Works with Claude, Codex, Cursor, opencode, and Copilot.
...
* **[Pluribus](https://github.com/caioribeiroclw-pixel/pluribus) ⭐ 14 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-18** – Open-source CLI that keeps one versioned AI coding context in sync across Claude Code, Cursor, Copilot, OpenClaw, Windsurf, Continue, and Zed.
...
* **[cc-code](https://github.com/cc-claws/cc-code) ⭐ 5 | 🐛 32 | 🌐 Rust | 📅 2026-09-23** – Rust-native terminal agent, Claude Code `.claude/` config compatible. Multi-model (DeepSeek/MiMo/GLM), \~50MB memory.
...
* **[agentchecker](https://github.com/moisesvalero/agentchecker) ⭐ 0 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21** – CLI that scans `AGENTS.md`, `CLAUDE.md`, Cursor rules, and Copilot instructions for contradictions and auto-fixes them. `npx agentchecker`
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 79,614 | 🐛 147 | 🌐 Python | 📅 2026-09-09** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,905 | 🐛 141 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
* **[Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,654 | 🐛 67 | 🌐 Go | 📅 2025-10-03** – AI tool for planning and generating code from text prompts in the terminal.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,509 | 🐛 287 | 🌐 TypeScript | 📅 2026-09-23** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
* **[StyleSeed](https://github.com/bitjaru/styleseed) ⭐ 962 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-18** – Design engine that makes Claude Code & Cursor produce professional UI — 33 components, 69 design rules, 8 brand skins, and a named framer-motion motion system.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 13,125 | 🐛 75 | 🌐 Python | 📅 2026-09-23** – Open-source AI agent for PR reviews with actionable insights.
* **[Sweep](https://github.com/sweepai/sweep) ⭐ 7,710 | 🐛 753 | 🌐 Jupyter Notebook | 📅 2025-09-18** – AI agent for automating PR reviews and fixes.
* **[brooks-lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,492 | 🐛 0 | 🌐 HTML | 📅 2026-09-21** – Claude Code plugin that reviews code against twelve classic engineering books, citing each finding to its source and scoring codebase health 0–100.
* **[OrcaCode Review](https://github.com/Continuum-AI-Corp/orca-code-review) ⭐ 166 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21** – GitHub Action for AI pull request review that posts findings inline on the affected lines and blocks merges on critical severity.
...
* **[argot](https://github.com/get-tmonier/argot) ⭐ 50 | 🐛 3 | 🌐 Rust | 📅 2026-09-10** – Guardrail that flags AI-written code foreign to a repo's own patterns (unfamiliar deps and APIs, reinvented functions, misplaced code, layering breaks, tests gamed to pass CI), learned statistically from git history. Runs 100% local as a single Rust binary, no second LLM.
...
* **[agent-qa](https://github.com/vostride/agent-qa) ⭐ 889 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03** – Self-improving QA agent for web and mobile apps with natural-language tests, run memory, UI-change adaptation, and regression detection.
...
* **[CocoIndex Code](https://github.com/cocoindex-io/cocoindex-code) ⭐ 2,716 | 🐛 42 | 🌐 Python | 📅 2026-09-22** – AST/tree-sitter code search MCP server that indexes a codebase and returns compact, relevant snippets to reduce coding-agent context usage.
* **[Reflex](https://github.com/reflex-search/reflex) ⭐ 73 | 🐛 2 | 🌐 Rust | 📅 2026-09-23** – Local-first full-text code search engine with MCP server and JSON output built for AI coding agents.
* **[codebase-recon](https://github.com/yujiachen-y/codebase-recon-skill) ⭐ 40 | 🐛 2 | 📅 2026-04-26** – AI coding agent skill that analyzes git history to reveal hotspots, bug magnets, bus factor risks, and development momentum before reading any code.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,981 | 🐛 206 | 🌐 Python | 📅 2026-09-23** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
* **[README-AI](https://github.com/eli64s/readme-ai) ⭐ 2,988 | 🐛 57 | 🌐 Python | 📅 2026-09-23** – AI tool for creating professional README files automatically.
* **[CodeAlmanac](https://github.com/AlmanacCode/codealmanac) ⭐ 995 | 🐛 53 | 🌐 TypeScript | 📅 2026-07-25** – Self-updating repo wiki for AI coding agents that tracks project conversations and context locally, lives in your repo, and is free to use.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,844 | 🐛 113 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[outsourcerer](https://github.com/alexgreensh/outsourcerer) ⭐ 154 | 🐛 4 | 🌐 Shell | 📅 2026-09-19** – Delegates coding grunt-work to other harnesses and models from the terminal while your main session stays the orchestrator.
...
* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,853 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,853 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22** – Open-source (MIT) Claude Code skills for SEO, GEO, Google Ads, and Meta Ads (\~2.9k stars). Connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP to run audits, manage campaigns, optimize meta tags and schema markup, and research keywords directly from Claude Code.

* **[Vibe-Coding Prompt Template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 3,103 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10** – Five-step planning workflow (deep research, PRD, tech design, `AGENTS.md`, build) with an `npx vibeworkflow` CLI that interviews you and writes the docs your coding agent reads. Free and MIT licensed.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,779 | 🐛 237 | 🌐 Rust | 📅 2026-09-22** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[PM Skills](https://github.com/mohitagw15856/pm-claude-skills) ⭐ 1,393 | 🐛 13 | 🌐 HTML | 📅 2026-09-23** – Open-source (MIT) library of 1,153 Agent Skills as plain-markdown `SKILL.md` files, covering PRDs, incident postmortems, code review checklists, RFCs, and 35 professions. Installs into Claude Code, Cursor, Windsurf, Zed and 10 more tools with one command, ships an MCP server, and runs free in a browser playground. Install: `npx pm-claude-skills add`.

* **[Vestige](https://github.com/samvallad33/vestige) ⭐ 631 | 🐛 17 | 🌐 Rust | 📅 2026-09-18** – Local-first MCP memory server for AI coding agents, with SQLite storage, retention-aware retrieval, provenance/correction tools, and a 3D dashboard.

* **[Claudexor](https://github.com/razzant/claudexor) ⭐ 481 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-23** – Local-first control plane for Claude Code, Codex, Cursor, and OpenCode with quota-aware profiles, cross-model review, and best-of-N runs.

* **[ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 421 | 🐛 63 | 🌐 Python | 📅 2026-09-23** – Self-hosted dashboard that reads the session logs coding agents already write on disk (Claude Code, Codex, Cursor, Aider, Goose, OpenClaw and others), so there is no SDK and nothing sits in the request path. Shows sessions, tool calls, tokens and cache-aware cost per session and per model. MIT core, `pip install clawmetry`. [Website](https://clawmetry.com)

* **[harmony-next.skills](https://github.com/linhay/harmony-next.skills) ⭐ 354 | 🐛 0 | 🌐 Python | 📅 2026-09-20** – Open-source HarmonyOS NEXT workflow toolkit for AI coding agents. Provides offline ArkTS/ArkUI/API references, DevEco/HDC/Emulator automation, UI/UX audit helpers, and smoke-test templates for mobile app development.
...
* **[MartinLoop](https://github.com/Keesan12/martin-loop) ⭐ 191 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23** – Open-source control layer for AI coding agents. Adds hard budget caps, verifier gates, explicit stop reasons, and run receipts around Claude Code, Codex, and Ralph-style autonomous coding workflows.

* **[codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 168 | 🐛 1 | 🌐 Shell | 📅 2026-09-15** – Open-source helper for switching OpenAI Codex CLI and Desktop accounts with isolated `CODEX_HOME` profiles instead of copying auth files.

* **[unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 146 | 🐛 4 | 🌐 Python | 📅 2026-09-21** – CLI and MCP server (Claude Code plugin) that removes named AI writing patterns from text. Targets tricolons, em-dash overuse, hedging stacks, sycophancy openers, and overused vocabulary. Lint-only audit mode and five intensity levels. Useful for cleaning commit messages, PR descriptions, and documentation drafts.
...
* **[AgentPlane](https://github.com/basilisk-labs/agentplane) ⭐ 79 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-23** – Local-first, Git-native CLI harness for repo-local coding-agent work, recording task state, accepted plans, verification evidence, and finish records inside the repository.
...
* **[dltHub AI Workbench](https://github.com/dlt-hub/dlthub-ai-workbench) ⭐ 59 | 🐛 7 | 🌐 Python | 📅 2026-09-23** – Toolkit that gives Claude Code, Cursor, and Codex structured, step-by-step workflows and an MCP server for building, exploring, and deploying data pipelines with dlt.

* **[ChatCrystal](https://github.com/ZengLiangYi/ChatCrystal) ⭐ 58 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21** – Local-first memory loop for AI coding conversations, with MCP search, task recall, writeback, and installable Agent Skills.

* **[LWC](https://github.com/JanYork/llm-wiki-cli) ⭐ 57 | 🐛 0 | 🌐 Rust | 📅 2026-09-13** – Open-source proactive project-memory CLI for AI coding agents, with source-grounded durable knowledge, SQLite/FTS5 retrieval, atomic updates, optional document/code graphs, and MCP/Skill/Hook integration across supported tools.

* **[EGC](https://github.com/Fmarzochi/EGC) ⭐ 55 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-23** – Persistent cross-session memory MCP server for 13+ AI coding tools. SQLite-backed state survives context resets and keeps Claude Code, Cursor, Gemini CLI, Codex, Windsurf, Amp, Kiro, VS Code Copilot, Trae, and more in sync. Install: `npm install -g @egchq/egc`.
...
* **[Harness for Codex](https://github.com/ganimjeong/Harness-for-codex) ⭐ 48 | 🐛 3 | 🌐 Shell | 📅 2026-05-30** – Language-agnostic repository template for consistent Codex and AI-assisted development workflows with AGENTS.md, standard scripts, CI, hooks, and docs.

* **[AgentDiff](https://github.com/codeprakhar25/agentdiff) ⭐ 45 | 🐛 11 | 🌐 Rust | 📅 2026-06-08** – Git-native provenance for AI-written code: records which AI agent (Claude Code, Cursor, Copilot, Codex, Windsurf, OpenCode, Gemini) wrote which line, reconciles it against each commit, and signs every attribution with ed25519. Records live in your own git refs; no server. Rust, MIT/Apache-2.0.

* **[Wolfpack](https://github.com/almogdepaz/wolfpack) ⭐ 40 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-23** – Self-hosted browser and mobile control center for persistent AI coding-agent and shell sessions across machines, with direct private access over Tailscale.
...
* **[DSH Studio](https://github.com/Moresyl/dsh-studio) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-09-22** – Open-source cross-platform desktop host for installing, running, health-checking, and supervising DeepSeek Harness locally.

* **[Data Olympus](https://github.com/knaisoma/data-olympus) ⭐ 25 | 🐛 14 | 🌐 Python | 📅 2026-09-23** – Governed project knowledge for AI coding agents via MCP. Agents can propose learnings, humans promote accepted guidance, and retrieval filters out expired or superseded rules before they enter future coding sessions.
...
* **[Mneme HQ](https://github.com/TheoV823/mneme) ⭐ 21 | 🐛 31 | 🌐 Python | 📅 2026-09-23** – Enforce architectural decisions on every AI coding assistant call. Deterministic retrieval and pre-flight governance for Claude Code, Cursor, and agent workflows.
...
* **[agents-md-cookbook](https://github.com/Taiizor/agents-md-cookbook) ⭐ 19 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-08** – Tool-agnostic AGENTS.md authoring kit (MIT) with 15 stack-specific templates, a tool compatibility matrix, an npm CLI + GitHub Action linter (`agents-md-lint`), and a migrator (`agents-md-migrate`) that converts `.cursorrules`, `CLAUDE.md`, Copilot, Windsurf, Cline, and Aider configs to AGENTS.md. Works across Cursor, Claude Code, Copilot, and 30+ AI coding tools. Free and open source.
...
* **[myc](https://github.com/aistastudio/myc) ⭐ 13 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19** – Open-source local memory and task queue for AI coding agents (Claude Code, Codex, opencode, Kimi): decisions survive context compaction, memory is anchored to code and follows it, everything stays in one SQLite file with no API key.

* **[Qovery Deploy Skill](https://github.com/Qovery/qovery-skills) ⭐ 12 | 🐛 4 | 🌐 Shell | 📅 2026-09-21** – AI Agent Skill that deploys any application to Kubernetes from Claude Code, Cursor, OpenCode, and 30+ AI coding tools. Analyzes codebases, creates Dockerfiles for 12+ frameworks, provisions databases, deploys via CLI+API or Terraform, and auto-fixes deployment failures. Install: `curl -fsSL https://skill.qovery.com/install.sh | bash`.

* **[ControlKeel](https://github.com/aryaminus/controlkeel) ⭐ 11 | 🐛 25 | 🌐 Elixir | 📅 2026-09-23** – Governance/control plane for AI coding agents. Validates risky actions, records findings, gates approvals, tracks budgets/providers, and creates proof bundles across Claude Code, Codex CLI, OpenCode, Cursor, and other hosts.
...
* **[AllPet](https://github.com/haverainlilili/all-pet) ⭐ 3 | 🐛 0 | 🌐 Swift | 📅 2026-09-23** – Open-source (MIT) desktop pet that watches your AI coding agents (Codex, Claude Code / Desktop, DeepSeek Harness, Grok) from local session logs — no accounts or API keys — and wakes the original session on click. Cross-platform `status`/`watch` CLI.
...
* **[Codex Skin Pack Installer](https://github.com/ChannelerH/codex-skin-packs/tree/main/codex-skin-pack-installer) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-09-22** – Codex skill that downloads verified public-safe Codex skin packs from GitHub releases, validates `theme.json`/`background.png`, stages packs locally, and keeps restore guidance in the workflow.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 59,494 | 🐛 5,205 | 🌐 Python | 📅 2026-09-23** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,593 | 🐛 318 | 🌐 C# | 📅 2026-09-19** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,402 | 🐛 638 | 🌐 TypeScript | 📅 2026-09-23** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
* **[AIWG](https://github.com/jmagly/aiwg) ⭐ 211 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-23** – Deploys reusable agents, skills, and governed workflows across multiple AI coding platforms.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 26,039 | 🐛 213 | 🌐 C++ | 📅 2026-09-23** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[token-optimizer](https://github.com/alexgreensh/token-optimizer) ⭐ 2,361 | 🐛 0 | 🌐 Python | 📅 2026-09-23** – Context and token-cost optimizer for AI coding agents. Finds wasted "ghost tokens," survives compaction, and reduces context-quality decay, with native plugins for Claude Code, Codex, OpenCode, and OpenClaw.
* **[KubeStellar Console](https://github.com/kubestellar/console) ⭐ 138 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-23** – Open-source multi-cluster Kubernetes dashboard with an MCP server (kc-agent) enabling AI coding agents to query and manage clusters via natural language.
...
* **[Bearer CLI](https://github.com/Bearer/bearer) ⭐ 2,748 | 🐛 21 | 🌐 Go | 📅 2026-09-21** – Open-source static security analysis for sensitive data exposure and GDPR/PCI compliance.
* **[repo-forensics](https://github.com/alexgreensh/repo-forensics) ⭐ 177 | 🐛 3 | 🌐 Python | 📅 2026-09-23** – Offline security scanner for AI-agent repos, skills, plugins, and MCP servers; detects prompt injection, credential theft, and manifest drift.
* **[gate.cat](https://github.com/BGMLAI/gate.cat) ⭐ 2 | 🐛 5 | 🌐 Python | 📅 2026-09-23** – Deterministic, fail-closed action veto for AI coding agents that blocks irreversible shell commands (rm -rf, DROP TABLE, terraform destroy) and secret exfiltration before they run, with no LLM in the veto path. Works as a Claude Code hook, a gated shell for any CLI agent, or a local OpenAI-API proxy.
...
* **[Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,195 | 🐛 67 | 🌐 Rust | 📅 2026-09-23** – Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* **[Entroly](https://github.com/juyterman1000/entroly) ⭐ 466 | 🐛 0 | 🌐 Python | 📅 2026-09-23** – Local-first MCP server for explicit-budget context selection, content-addressed exact recovery, and auditable Context Receipts. Apache-2.0.
* **[piia-engram](https://github.com/Patdolitse/piia-engram) ⭐ 161 | 🐛 0 | 🌐 Python | 📅 2026-09-23** – Cross-tool persistent memory MCP server. Stores preferences, standards, and lessons locally across Claude Code, Cursor, Codex, and any MCP client.
...
* **[agent-lsp](https://github.com/blackwell-systems/agent-lsp) ⭐ 134 | 🐛 2 | 🌐 Go | 📅 2026-09-23** – MCP server that gives AI coding agents language server intelligence (go-to-definition, find-references, diagnostics, refactoring, speculative execution) across 30 languages. 56 tools, 22 agent skills, single Go binary.
* **[Claudex](https://github.com/kunwar-shah/claudex) ⭐ 95 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-20** – Open-source MCP server giving Claude Code persistent memory and FTS5 full-text search across conversation history.
* **[RunAPI MCP Server](https://github.com/runapi-ai/mcp) ⭐ 55 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22** – 130+ AI models for image, video, music, audio, and LLM generation from 18 providers via `npx @runapi.ai/mcp`. Free catalog tools for model discovery and pricing; authenticated tools for media generation and LLM chat.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,266 | 🐛 1,369 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 840 | 🐛 99 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
* **[Awesome AI Agents](https://github.com/aylar-ghezelbash/awesome-ai-agents) ⭐ 151 | 🐛 54 | 📅 2026-02-02** – AI agents for automation and development.
