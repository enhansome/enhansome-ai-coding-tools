...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,521 | 🐛 106 | 📅 2026-09-02
...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,061 | 🐛 357 | 📅 2026-04-25.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,879 | 🐛 825 | 🌐 TypeScript | 📅 2026-09-09** – Google's terminal coding agent powered by Gemini.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,275 | 🐛 1 | 🌐 Rust | 📅 2026-09-09** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 67,741 | 🐛 1,281 | 🌐 TypeScript | 📅 2026-09-09** – VS Code extension with full file system access and autonomous coding.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 60,900 | 🐛 1,064 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 54,064 | 🐛 300 | 🌐 Rust | 📅 2026-09-09** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,856 | 🐛 1,858 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,292 | 🐛 102 | 🌐 Python | 📅 2026-09-07** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[Smol Developer](https://github.com/smol-ai/developer) ⭐ 12,184 | 🐛 86 | 🌐 Python | 📅 2024-04-07** – Lightweight AI coding agent for rapid prototyping.
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,038 | 🐛 94 | 🌐 Python | 📅 2026-09-09** – Multi-agent framework with 100+ LLM support and MCP integration.
* **[SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 668 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-30** – Self-hosted multi-agent runtime with MCP client and server support, 23+ LLM providers, persistent memory, skills, schedules, and messaging connectors. Electron desktop app, CLI, and Docker.
* **[OpenASE](https://github.com/PacificStudio/openase) ⭐ 267 | 🐛 45 | 🌐 Go | 📅 2026-08-09** – Open-source, ticket-driven software engineering platform that orchestrates Claude Code, Codex, and Gemini CLI agents across your machines with workflows, skills, and full traceability.
* **[brood-box](https://github.com/stacklok/brood-box) ⭐ 65 | 🐛 13 | 🌐 Go | 📅 2026-09-08** – Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation, egress control, and MCP authorization.
* **[OpenMagic](https://github.com/Kalmuraee/OpenMagic) ⭐ 13 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-28** – AI-powered coding toolbar for any web app. Injects a floating toolbar via reverse proxy, captures element context, previews diffs, and applies approved changes in real time.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,879 | 🐛 825 | 🌐 TypeScript | 📅 2026-09-09** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,856 | 🐛 1,858 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,214 | 🐛 1,085 | 🌐 Go | 📅 2026-09-09** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[ShellGPT](https://github.com/TheR1D/shell_gpt) ⭐ 12,275 | 🐛 121 | 🌐 Python | 📅 2026-07-02** – ChatGPT integration for shell command generation and system administration.
* **[AICommits](https://github.com/Nutlope/aicommits) ⭐ 9,097 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-05** – AI-powered meaningful git commit message generation.
* **[agx](https://github.com/ramarlina/agx) ⭐ 28 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-06** – Checkpoint-based execution engine for AI coding agents; durable Wake→Work→Sleep loops that resume across sessions. Supports Claude Code, Codex, Gemini CLI, and Ollama.
* **[codachi](https://github.com/vincent-k2026/codachi) ⭐ 12 | 🐛 3 | 🌐 TypeScript | 📅 2026-04-18** – Context window monitor for Claude Code that shows burn rate and time remaining, with an ASCII pet that reacts to your workflow.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 78,400 | 🐛 144 | 🌐 Python | 📅 2026-09-09** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,858 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
* **[Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,630 | 🐛 63 | 🌐 Go | 📅 2025-10-03** – AI tool for planning and generating code from text prompts in the terminal.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,274 | 🐛 294 | 🌐 TypeScript | 📅 2026-09-09** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,918 | 🐛 114 | 🌐 Python | 📅 2026-09-09** – Open-source AI agent for PR reviews with actionable insights.
* **[Sweep](https://github.com/sweepai/sweep) ⭐ 7,708 | 🐛 754 | 🌐 Jupyter Notebook | 📅 2025-09-18** – AI agent for automating PR reviews and fixes.
...
* **[Relay](https://github.com/momobits/Relay/) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-20** – Persistent memory for AI coding workflows. Give AI coding agents memory of what was built, what broke, and what's next.
* **[SynthScan](https://github.com/marcoramilli/SynthScan) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-07-18** – Scans codebases for AI-generated code patterns.
...
* **[codebase-recon](https://github.com/yujiachen-y/codebase-recon-skill) ⭐ 37 | 🐛 0 | 📅 2026-04-26** – AI coding agent skill that analyzes git history to reveal hotspots, bug magnets, bus factor risks, and development momentum before reading any code.

***

## Documentation

* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,387 | 🐛 171 | 🌐 Python | 📅 2026-09-09** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
* **[README-AI](https://github.com/eli64s/readme-ai) ⭐ 2,982 | 🐛 57 | 🌐 Python | 📅 2026-09-09** – AI tool for creating professional README files automatically.
* **[SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 682 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-30** – Local-first RAG knowledge vault. Compiles raw sources into a durable markdown wiki with a knowledge graph and hybrid SQLite FTS plus embeddings. Built-in MCP server for Claude Code, Codex, and OpenCode.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,831 | 🐛 112 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[DeepSeek Coder](https://github.com/deepseek-ai/DeepSeek-Coder-V2) ⭐ 7,007 | 🐛 78 | 📅 2025-11-11** – High-performance open-source coding model; popular for cost-efficient AI coding via API.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,062 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,698 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-09** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,548 | 🐛 207 | 🌐 Rust | 📅 2026-09-09** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[git-parsec](https://github.com/erishforG/git-parsec) ⭐ 15 | 🐛 9 | 🌐 Rust | 📅 2026-09-09** – Git worktree lifecycle manager that gives each AI agent an isolated workspace tied to issue tickets (Jira, GitHub Issues, GitLab), avoiding index.lock conflicts in parallel workflows.

* **[Qovery Deploy Skill](https://github.com/Qovery/qovery-skills) ⭐ 11 | 🐛 3 | 🌐 Shell | 📅 2026-09-01** – AI Agent Skill that deploys any application to Kubernetes from Claude Code, Cursor, OpenCode, and 30+ AI coding tools. Analyzes codebases, creates Dockerfiles for 12+ frameworks, provisions databases, deploys via CLI+API or Terraform, and auto-fixes deployment failures. Install: `curl -fsSL https://skill.qovery.com/install.sh | bash`.

* **[Google Drive – Memyard](https://github.com/zagmoai/public-google-drive) ⭐ 1 | 🐛 0 | 📅 2026-03-03** – Agent skill that lets AI coding agents create and edit Google Docs and Sheets without sign-in. Documents hosted on Memyard with shareable links.

* **[Agent Cost Guardrails](https://github.com/sapph1re/agent-cost-guardrails) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-07-01** – Framework-native budget limits and circuit breakers for AI agent frameworks (CrewAI, AutoGen, LangGraph). Hard token caps, cost alerts, and spend tracking with hooks that integrate directly into agent execution loops. Open-source, available on [PyPI](https://pypi.org/project/agent-cost-guardrails/) and [npm](https://npmjs.com/package/agent-cost-guardrails).
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 58,390 | 🐛 5,035 | 🌐 Python | 📅 2026-09-09** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,550 | 🐛 269 | 🌐 C# | 📅 2026-09-09** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,977 | 🐛 655 | 🌐 TypeScript | 📅 2026-09-09** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,929 | 🐛 212 | 🌐 C++ | 📅 2026-09-08** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[Bearer CLI](https://github.com/Bearer/bearer) ⭐ 2,743 | 🐛 22 | 🌐 Go | 📅 2026-09-08** – Open-source static security analysis for sensitive data exposure and GDPR/PCI compliance.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,167 | 🐛 1,309 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 835 | 🐛 90 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
* **[Awesome AI Agents](https://github.com/aylar-ghezelbash/awesome-ai-agents) ⭐ 149 | 🐛 51 | 📅 2026-02-02** – AI agents for automation and development.
