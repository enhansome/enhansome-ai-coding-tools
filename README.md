...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,776 | 🐛 102 | 📅 2026-08-18
...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,014 | 🐛 324 | 📅 2026-04-25.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,579 | 🐛 792 | 🌐 TypeScript | 📅 2026-08-19** – Google's terminal coding agent powered by Gemini.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,075 | 🐛 4 | 🌐 Rust | 📅 2026-08-19** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 66,489 | 🐛 1,054 | 🌐 TypeScript | 📅 2026-08-19** – VS Code extension with full file system access and autonomous coding.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 60,522 | 🐛 998 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 53,003 | 🐛 311 | 🌐 Rust | 📅 2026-08-19** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,332 | 🐛 1,818 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,081 | 🐛 82 | 🌐 Python | 📅 2026-08-17** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[Smol Developer](https://github.com/smol-ai/developer) ⭐ 12,186 | 🐛 87 | 🌐 Python | 📅 2024-04-07** – Lightweight AI coding agent for rapid prototyping.
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 8,922 | 🐛 51 | 🌐 Python | 📅 2026-08-19** – Multi-agent framework with 100+ LLM support and MCP integration.
* **[SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 648 | 🐛 14 | 🌐 TypeScript | 📅 2026-06-30** – Self-hosted multi-agent runtime with MCP client and server support, 23+ LLM providers, persistent memory, skills, schedules, and messaging connectors. Electron desktop app, CLI, and Docker.
...
* **[brood-box](https://github.com/stacklok/brood-box) ⭐ 58 | 🐛 13 | 🌐 Go | 📅 2026-08-18** – Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation, egress control, and MCP authorization.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,579 | 🐛 792 | 🌐 TypeScript | 📅 2026-08-19** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,332 | 🐛 1,818 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 45,889 | 🐛 1,083 | 🌐 Go | 📅 2026-08-19** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[ShellGPT](https://github.com/TheR1D/shell_gpt) ⭐ 12,246 | 🐛 118 | 🌐 Python | 📅 2026-07-02** – ChatGPT integration for shell command generation and system administration.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 74,238 | 🐛 128 | 🌐 Python | 📅 2026-08-14** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,767 | 🐛 131 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 36,853 | 🐛 353 | 🌐 TypeScript | 📅 2026-08-19** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,619 | 🐛 118 | 🌐 Python | 📅 2026-08-19** – Open-source AI agent for PR reviews with actionable insights.
* **[Sweep](https://github.com/sweepai/sweep) ⭐ 7,700 | 🐛 752 | 🌐 Jupyter Notebook | 📅 2025-09-18** – AI agent for automating PR reviews and fixes.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,085 | 🐛 160 | 🌐 Python | 📅 2026-08-19** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
* **[README-AI](https://github.com/eli64s/readme-ai) ⭐ 2,971 | 🐛 69 | 🌐 Python | 📅 2026-07-04** – AI tool for creating professional README files automatically.
* **[SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 660 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-30** – Local-first RAG knowledge vault. Compiles raw sources into a durable markdown wiki with a knowledge graph and hybrid SQLite FTS plus embeddings. Built-in MCP server for Claude Code, Codex, and OpenCode.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,799 | 🐛 111 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[DeepSeek Coder](https://github.com/deepseek-ai/DeepSeek-Coder-V2) ⭐ 6,991 | 🐛 78 | 📅 2025-11-11** – High-performance open-source coding model; popular for cost-efficient AI coding via API.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,002 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,375 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,473 | 🐛 183 | 🌐 Rust | 📅 2026-08-19** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[git-parsec](https://github.com/erishforG/git-parsec) ⭐ 15 | 🐛 18 | 🌐 Rust | 📅 2026-08-19** – Git worktree lifecycle manager that gives each AI agent an isolated workspace tied to issue tickets (Jira, GitHub Issues, GitLab), avoiding index.lock conflicts in parallel workflows.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 56,764 | 🐛 5,001 | 🌐 Python | 📅 2026-08-19** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,465 | 🐛 249 | 🌐 C# | 📅 2026-08-19** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,379 | 🐛 509 | 🌐 TypeScript | 📅 2026-08-19** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,648 | 🐛 213 | 🌐 C++ | 📅 2026-08-17** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[Bearer CLI](https://github.com/Bearer/bearer) ⭐ 2,730 | 🐛 19 | 🌐 Go | 📅 2026-08-17** – Open-source static security analysis for sensitive data exposure and GDPR/PCI compliance.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 5,997 | 🐛 1,223 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 817 | 🐛 78 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
* **[Awesome AI Agents](https://github.com/aylar-ghezelbash/awesome-ai-agents) ⭐ 149 | 🐛 46 | 📅 2026-02-02** – AI agents for automation and development.
