...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,587 | 🐛 105 | 📅 2026-08-21
...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,040 | 🐛 342 | 📅 2026-04-25.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,722 | 🐛 870 | 🌐 TypeScript | 📅 2026-08-28** – Google's terminal coding agent powered by Gemini.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,172 | 🐛 7 | 🌐 Rust | 📅 2026-08-20** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 67,028 | 🐛 1,122 | 🌐 TypeScript | 📅 2026-08-28** – VS Code extension with full file system access and autonomous coding.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 60,658 | 🐛 989 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 53,588 | 🐛 221 | 🌐 Rust | 📅 2026-08-27** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,539 | 🐛 1,827 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,159 | 🐛 82 | 🌐 Python | 📅 2026-08-24** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 8,969 | 🐛 86 | 🌐 Python | 📅 2026-08-28** – Multi-agent framework with 100+ LLM support and MCP integration.
...
* **[brood-box](https://github.com/stacklok/brood-box) ⭐ 63 | 🐛 13 | 🌐 Go | 📅 2026-08-27** – Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation, egress control, and MCP authorization.
* **[OpenMagic](https://github.com/Kalmuraee/OpenMagic) ⭐ 13 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-27** – AI-powered coding toolbar for any web app. Injects a floating toolbar via reverse proxy, captures element context, previews diffs, and applies approved changes in real time.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,722 | 🐛 870 | 🌐 TypeScript | 📅 2026-08-28** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,539 | 🐛 1,827 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,031 | 🐛 1,065 | 🌐 Go | 📅 2026-08-27** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 75,125 | 🐛 130 | 🌐 Python | 📅 2026-08-14** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,817 | 🐛 132 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,082 | 🐛 369 | 🌐 TypeScript | 📅 2026-08-28** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,737 | 🐛 94 | 🌐 Python | 📅 2026-08-27** – Open-source AI agent for PR reviews with actionable insights.
* **[Sweep](https://github.com/sweepai/sweep) ⭐ 7,706 | 🐛 752 | 🌐 Jupyter Notebook | 📅 2025-09-18** – AI agent for automating PR reviews and fixes.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,246 | 🐛 177 | 🌐 Python | 📅 2026-08-27** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
* **[README-AI](https://github.com/eli64s/readme-ai) ⭐ 2,979 | 🐛 58 | 🌐 Python | 📅 2026-08-26** – AI tool for creating professional README files automatically.
* **[SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 672 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-30** – Local-first RAG knowledge vault. Compiles raw sources into a durable markdown wiki with a knowledge graph and hybrid SQLite FTS plus embeddings. Built-in MCP server for Claude Code, Codex, and OpenCode.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,814 | 🐛 112 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,029 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,421 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,513 | 🐛 158 | 🌐 Rust | 📅 2026-08-27** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[git-parsec](https://github.com/erishforG/git-parsec) ⭐ 15 | 🐛 18 | 🌐 Rust | 📅 2026-08-28** – Git worktree lifecycle manager that gives each AI agent an isolated workspace tied to issue tickets (Jira, GitHub Issues, GitLab), avoiding index.lock conflicts in parallel workflows.

* **[Qovery Deploy Skill](https://github.com/Qovery/qovery-skills) ⭐ 9 | 🐛 3 | 🌐 Shell | 📅 2026-08-27** – AI Agent Skill that deploys any application to Kubernetes from Claude Code, Cursor, OpenCode, and 30+ AI coding tools. Analyzes codebases, creates Dockerfiles for 12+ frameworks, provisions databases, deploys via CLI+API or Terraform, and auto-fixes deployment failures. Install: `curl -fsSL https://skill.qovery.com/install.sh | bash`.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 57,435 | 🐛 4,852 | 🌐 Python | 📅 2026-08-28** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,508 | 🐛 262 | 🌐 C# | 📅 2026-08-27** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,626 | 🐛 535 | 🌐 TypeScript | 📅 2026-08-28** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,708 | 🐛 212 | 🌐 C++ | 📅 2026-08-26** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[Bearer CLI](https://github.com/Bearer/bearer) ⭐ 2,739 | 🐛 17 | 🌐 Go | 📅 2026-08-24** – Open-source static security analysis for sensitive data exposure and GDPR/PCI compliance.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,063 | 🐛 1,256 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 824 | 🐛 83 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
