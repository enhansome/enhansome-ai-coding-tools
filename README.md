...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,617 | 🐛 106 | 📅 2026-09-02
...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,097 | 🐛 138 | 📅 2026-09-18.
...
* **[Cate](https://github.com/0-AI-UG/cate) ⭐ 2,148 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-21** – Infinite zoomable canvas IDE where editor, terminal, browser, and Claude Code agent panels float spatially, like Figma or Miro but for coding.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,117 | 🐛 833 | 🌐 TypeScript | 📅 2026-09-21** – Google's terminal coding agent powered by Gemini.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 68,971 | 🐛 1,391 | 🌐 TypeScript | 📅 2026-09-21** – VS Code extension with full file system access and autonomous coding.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,397 | 🐛 3 | 🌐 Rust | 📅 2026-09-20** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 61,099 | 🐛 1,089 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 54,540 | 🐛 388 | 🌐 Rust | 📅 2026-09-21** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 49,104 | 🐛 1,883 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[Dcode](https://github.com/langchain-ai/deepagents) ⭐ 29,627 | 🐛 201 | 🌐 Python | 📅 2026-09-21** – The coding agent you own. Open-source, model-agnostic, and built by LangChain to give you maximum control over your software development lifecycle.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,382 | 🐛 117 | 🌐 Python | 📅 2026-09-21** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[Smol Developer](https://github.com/smol-ai/developer) ⭐ 12,190 | 🐛 87 | 🌐 Python | 📅 2024-04-07** – Lightweight AI coding agent for rapid prototyping.
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,081 | 🐛 114 | 🌐 Python | 📅 2026-09-18** – Multi-agent framework with 100+ LLM support and MCP integration.
* **[Maestro](https://github.com/RunMaestro/Maestro) ⭐ 3,357 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-21** – Open-source desktop command center for running multiple AI coding agents (Claude Code, Codex, Gemini CLI, etc.) in parallel, with Cue event automation, Auto Run playbooks, Group Chat across local and remote agents, and a maestro-cli that agents can drive themselves.
* **[Atomic Agent](https://github.com/AtomicBot-ai/atomic-agent) ⭐ 2,528 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-21** – Local-first coding agent that runs open-weight models entirely on your machine via a llama.cpp fork. 56 built-in tools (browser, filesystem, git, memory, vision), MCP support, and a five-layer memory system. No account or API key required.
* **[BitFun](https://github.com/GCWing/BitFun) ⭐ 2,307 | 🐛 66 | 🌐 Rust | 📅 2026-09-21** – Cross-platform desktop coding agent built on a Rust runtime, with Git-aware workflows, Deep Review, MCP/Skills/Hooks, remote workspaces, and state-bound Mini Apps.
* **[Orkas](https://github.com/Orkas-AI/Orkas) ⭐ 2,104 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-21** – Open-source local-first desktop workspace that runs Claude Code, Codex CLI, OpenCode, Cline, and built-in agents in parallel with shared files and approval controls. [Website](https://orkas.ai?source=gh-codingtools)
...
* **[OpenCode Mobile](https://github.com/dzianisv/opencode-mobile) ⭐ 180 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-20** – Open-source (MIT) Android client for the OpenCode coding agent; run AI coding sessions from your phone against your own self-hosted server with bring-your-own keys.
* **[LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 152 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21** – Local GUI orchestrator for long-running, high-correctness AI software delivery — LLM councils plan it, Ralph loops perfect it, OpenCode worktrees ship it.
* **[Ordewell](https://github.com/ordewell/ordewell) ⭐ 135 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-20** – Plan-first CLI/TUI orchestrator that turns one goal into an ordered plan of coding-agent tasks, each with its own runner (Claude Code, Codex, OpenCode), model, thinking effort and mode — editable before execution, run as one agent session per task, and marked done only when its own completion marker appears in the output. Apache-2.0, free, no paid tier.
* **[DvalinCode](https://github.com/arthurpanhku/dvalincode) ⭐ 117 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-21** – Provider-neutral, local-first CLI coding agent (Chat/Cowork/Code modes) built for governance: org policy engine, enforced network egress, and a verifiable hash-chained audit trail. Works with any OpenAI-compatible endpoint (DeepSeek, OpenAI, Claude via OpenRouter, Groq, Ollama). Zero runtime deps. MIT.
...
* **[Emdash Skills](https://github.com/megabytespace/claude-skills) ⭐ 22 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-21** – 14-category autonomous product-building OS with 18 specialized agents that turn one-line prompts into deployed products on Cloudflare Workers.
* **[Claude Skills](https://github.com/heymegabyte/claude-skills) ⭐ 22 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-21** – 14-category autonomous product-building OS bundling 18 specialized agents (architect, test-writer, deploy-verifier, security-reviewer, visual-qa, performance-profiler, accessibility-auditor, content-writer, completeness-checker, dependency-auditor, migration-agent, incident-responder, computer-use-operator, meta-orchestrator, seo-auditor, cost-estimator, changelog-generator, code-simplifier). One config drops into Claude Code, Codex, Cursor, Copilot, Gemini CLI, Windsurf, opencode, Cline, and Aider. One-line prompts deploy production sites with hard quality gates (Playwright at 6 breakpoints, axe-core 0 violations, Lighthouse a11y >=95, AI vision >=8/10).
...
* **[cc-code](https://github.com/cc-claws/cc-code) ⭐ 4 | 🐛 31 | 🌐 Rust | 📅 2026-09-21** – Open-source Rust terminal coding agent, Claude Code compatible. Runs DeepSeek, MiMo, GLM with \~50MB memory and 95-99% prompt cache hit rate.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 107,117 | 🐛 833 | 🌐 TypeScript | 📅 2026-09-21** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 49,104 | 🐛 1,883 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,360 | 🐛 1,089 | 🌐 Go | 📅 2026-09-21** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[ShellGPT](https://github.com/TheR1D/shell_gpt) ⭐ 12,283 | 🐛 121 | 🌐 Python | 📅 2026-07-02** – ChatGPT integration for shell command generation and system administration.
* **[AICommits](https://github.com/Nutlope/aicommits) ⭐ 9,101 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-05** – AI-powered meaningful git commit message generation.
* **[fx](https://github.com/vercel-labs/fx) ⭐ 3,098 | 🐛 226 | 🌐 Zig | 📅 2026-09-21** – Tiny, open-source coding agent harness by Vercel Labs, written in Zig; model-agnostic, Unix-shell-like output, and embeddable in agent sandboxes.
* **[Webcmd](https://github.com/agentrhq/webcmd) ⭐ 2,249 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-11** – Self-learning browser infrastructure CLI for coding agents; learns a site once, then reuses it as deterministic per-site commands.
* **[Vox Director](https://github.com/Alisa0808/vox-director) ⭐ 1,995 | 🐛 3 | 🌐 Python | 📅 2026-08-11** – Agent skill that turns one topic into a finished Vox-style paper-collage explainer/ad video (script, collage art, motion, voice-over, music, captions); runs on Atlas Cloud + ffmpeg. Works with Claude Code, Codex & any SKILL.md agent.
...
* **[AgentBridge](https://github.com/raysonmeng/agent-bridge) ⭐ 352 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-21** – Local MIT CLI that keeps Claude Code and Codex as live peers in one session for mid-turn review and quota-boundary handoff.
...
* **[oh-my-kimi](https://github.com/dmae97/oh-my-kimi) ⭐ 144 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21** – Multi-agent orchestration harness for Kimi K2.6. Parallel coding teams in git worktrees, DAG scheduling, live quality gates, terminal HUD, and MCP skill-hooks.
...
* **[RoleCraft](https://github.com/rolecraft-sh/rolecraft) ⭐ 80 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-18** – Zero-dependency CLI to install AI agent skills as roles & behaviors from any source. Works with 86 coding agents.
* **[Crab Code](https://github.com/crabforge/crab-code) ⭐ 76 | 🐛 11 | 🌐 Rust | 📅 2026-09-07** – Rust-native agentic coding CLI supporting any LLM provider with multi-entry-point architecture (CLI/IDE/Web/Desktop). Apache-2.0.
...
* **[AI Badger](https://github.com/PVRLabs/aibadger) ⭐ 41 | 🐛 1 | 🌐 Go | 📅 2026-09-21** – Local-first CLI for extracting clean, relevant codebase context to paste into any AI coding assistant.
...
* **[cc-code](https://github.com/cc-claws/cc-code) ⭐ 4 | 🐛 31 | 🌐 Rust | 📅 2026-09-21** – Rust-native terminal agent, Claude Code `.claude/` config compatible. Multi-model (DeepSeek/MiMo/GLM), \~50MB memory.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 79,485 | 🐛 146 | 🌐 Python | 📅 2026-09-09** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
* **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,894 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-07** – Open-source fork of Bolt.new supporting any LLM (local or cloud) for building full-stack apps in the browser.
* **[Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,650 | 🐛 62 | 🌐 Go | 📅 2025-10-03** – AI tool for planning and generating code from text prompts in the terminal.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,454 | 🐛 273 | 🌐 TypeScript | 📅 2026-09-21** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 13,102 | 🐛 45 | 🌐 Python | 📅 2026-09-21** – Open-source AI agent for PR reviews with actionable insights.
* **[Sweep](https://github.com/sweepai/sweep) ⭐ 7,711 | 🐛 753 | 🌐 Jupyter Notebook | 📅 2025-09-18** – AI agent for automating PR reviews and fixes.
* **[brooks-lint](https://github.com/hyhmrright/brooks-lint) ⭐ 1,487 | 🐛 0 | 🌐 HTML | 📅 2026-09-21** – Claude Code plugin that reviews code against twelve classic engineering books, citing each finding to its source and scoring codebase health 0–100.
* **[OrcaCode Review](https://github.com/Continuum-AI-Corp/orca-code-review) ⭐ 165 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21** – GitHub Action for AI pull request review that posts findings inline on the affected lines and blocks merges on critical severity.
...
* **[CocoIndex Code](https://github.com/cocoindex-io/cocoindex-code) ⭐ 2,714 | 🐛 44 | 🌐 Python | 📅 2026-09-18** – AST/tree-sitter code search MCP server that indexes a codebase and returns compact, relevant snippets to reduce coding-agent context usage.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,826 | 🐛 205 | 🌐 Python | 📅 2026-09-21** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
...
* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,840 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.

* **[NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,840 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21** – Open-source (MIT) Claude Code skills for SEO, GEO, Google Ads, and Meta Ads (\~2.9k stars). Connects to live data via Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP to run audits, manage campaigns, optimize meta tags and schema markup, and research keywords directly from Claude Code.

* **[Vibe-Coding Prompt Template](https://github.com/KhazP/vibe-coding-prompt-template) ⭐ 3,093 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10** – Five-step planning workflow (deep research, PRD, tech design, `AGENTS.md`, build) with an `npx vibeworkflow` CLI that interviews you and writes the docs your coding agent reads. Free and MIT licensed.

* **[Git AI](https://github.com/acunniffe/git-ai) ⭐ 2,762 | 🐛 229 | 🌐 Rust | 📅 2026-09-21** – Git extension that tracks AI-generated code and the prompts behind each line.

* **[PM Skills](https://github.com/mohitagw15856/pm-claude-skills) ⭐ 1,384 | 🐛 13 | 🌐 HTML | 📅 2026-09-21** – Open-source (MIT) library of 1,153 Agent Skills as plain-markdown `SKILL.md` files, covering PRDs, incident postmortems, code review checklists, RFCs, and 35 professions. Installs into Claude Code, Cursor, Windsurf, Zed and 10 more tools with one command, ships an MCP server, and runs free in a browser playground. Install: `npx pm-claude-skills add`.
...
* **[codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 163 | 🐛 1 | 🌐 Shell | 📅 2026-09-15** – Open-source helper for switching OpenAI Codex CLI and Desktop accounts with isolated `CODEX_HOME` profiles instead of copying auth files.

* **[unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 144 | 🐛 3 | 🌐 Python | 📅 2026-09-21** – CLI and MCP server (Claude Code plugin) that removes named AI writing patterns from text. Targets tricolons, em-dash overuse, hedging stacks, sycophancy openers, and overused vocabulary. Lint-only audit mode and five intensity levels. Useful for cleaning commit messages, PR descriptions, and documentation drafts.
...
* **[AgentPlane](https://github.com/basilisk-labs/agentplane) ⭐ 77 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-21** – Local-first, Git-native CLI harness for repo-local coding-agent work, recording task state, accepted plans, verification evidence, and finish records inside the repository.
...
* **[dltHub AI Workbench](https://github.com/dlt-hub/dlthub-ai-workbench) ⭐ 59 | 🐛 4 | 🌐 Python | 📅 2026-09-21** – Toolkit that gives Claude Code, Cursor, and Codex structured, step-by-step workflows and an MCP server for building, exploring, and deploying data pipelines with dlt.
...
* **[Harness for Codex](https://github.com/ganimjeong/Harness-for-codex) ⭐ 46 | 🐛 3 | 🌐 Shell | 📅 2026-05-30** – Language-agnostic repository template for consistent Codex and AI-assisted development workflows with AGENTS.md, standard scripts, CI, hooks, and docs.

* **[AgentDiff](https://github.com/codeprakhar25/agentdiff) ⭐ 44 | 🐛 11 | 🌐 Rust | 📅 2026-06-08** – Git-native provenance for AI-written code: records which AI agent (Claude Code, Cursor, Copilot, Codex, Windsurf, OpenCode, Gemini) wrote which line, reconciles it against each commit, and signs every attribution with ed25519. Records live in your own git refs; no server. Rust, MIT/Apache-2.0.

* **[Wolfpack](https://github.com/almogdepaz/wolfpack) ⭐ 39 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21** – Self-hosted browser and mobile control center for persistent AI coding-agent and shell sessions across machines, with direct private access over Tailscale.
...
* **[Data Olympus](https://github.com/knaisoma/data-olympus) ⭐ 25 | 🐛 13 | 🌐 Python | 📅 2026-09-21** – Governed project knowledge for AI coding agents via MCP. Agents can propose learnings, humans promote accepted guidance, and retrieval filters out expired or superseded rules before they enter future coding sessions.
...
* **[Mneme HQ](https://github.com/TheoV823/mneme) ⭐ 21 | 🐛 31 | 🌐 Python | 📅 2026-09-21** – Enforce architectural decisions on every AI coding assistant call. Deterministic retrieval and pre-flight governance for Claude Code, Cursor, and agent workflows.
...
* **[ControlKeel](https://github.com/aryaminus/controlkeel) ⭐ 11 | 🐛 20 | 🌐 Elixir | 📅 2026-09-21** – Governance/control plane for AI coding agents. Validates risky actions, records findings, gates approvals, tracks budgets/providers, and creates proof bundles across Claude Code, Codex CLI, OpenCode, Cursor, and other hosts.
...
* **[AllPet](https://github.com/haverainlilili/all-pet) ⭐ 3 | 🐛 0 | 🌐 Swift | 📅 2026-09-21** – Open-source (MIT) desktop pet that watches your AI coding agents (Codex, Claude Code / Desktop, DeepSeek Harness, Grok) from local session logs — no accounts or API keys — and wakes the original session on click. Cross-platform `status`/`watch` CLI.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 59,344 | 🐛 5,228 | 🌐 Python | 📅 2026-09-21** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,587 | 🐛 312 | 🌐 C# | 📅 2026-09-19** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,341 | 🐛 629 | 🌐 TypeScript | 📅 2026-09-21** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
* **[AIWG](https://github.com/jmagly/aiwg) ⭐ 211 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-21** – Deploys reusable agents, skills, and governed workflows across multiple AI coding platforms.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 26,019 | 🐛 212 | 🌐 C++ | 📅 2026-09-16** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[token-optimizer](https://github.com/alexgreensh/token-optimizer) ⭐ 2,344 | 🐛 2 | 🌐 Python | 📅 2026-09-17** – Context and token-cost optimizer for AI coding agents. Finds wasted "ghost tokens," survives compaction, and reduces context-quality decay, with native plugins for Claude Code, Codex, OpenCode, and OpenClaw.
* **[KubeStellar Console](https://github.com/kubestellar/console) ⭐ 137 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21** – Open-source multi-cluster Kubernetes dashboard with an MCP server (kc-agent) enabling AI coding agents to query and manage clusters via natural language.
...
* **[Bearer CLI](https://github.com/Bearer/bearer) ⭐ 2,746 | 🐛 21 | 🌐 Go | 📅 2026-09-21** – Open-source static security analysis for sensitive data exposure and GDPR/PCI compliance.
* **[repo-forensics](https://github.com/alexgreensh/repo-forensics) ⭐ 177 | 🐛 9 | 🌐 Python | 📅 2026-09-13** – Offline security scanner for AI-agent repos, skills, plugins, and MCP servers; detects prompt injection, credential theft, and manifest drift.
* **[gate.cat](https://github.com/BGMLAI/gate.cat) ⭐ 2 | 🐛 5 | 🌐 Python | 📅 2026-09-21** – Deterministic, fail-closed action veto for AI coding agents that blocks irreversible shell commands (rm -rf, DROP TABLE, terraform destroy) and secret exfiltration before they run, with no LLM in the veto path. Works as a Claude Code hook, a gated shell for any CLI agent, or a local OpenAI-API proxy.
...
* **[Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 1,167 | 🐛 67 | 🌐 Rust | 📅 2026-09-21** – Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* **[Entroly](https://github.com/juyterman1000/entroly) ⭐ 465 | 🐛 0 | 🌐 Python | 📅 2026-09-21** – Local-first MCP server for explicit-budget context selection, content-addressed exact recovery, and auditable Context Receipts. Apache-2.0.
...
* **[agent-lsp](https://github.com/blackwell-systems/agent-lsp) ⭐ 133 | 🐛 3 | 🌐 Go | 📅 2026-09-21** – MCP server that gives AI coding agents language server intelligence (go-to-definition, find-references, diagnostics, refactoring, speculative execution) across 30 languages. 56 tools, 22 agent skills, single Go binary.
* **[Claudex](https://github.com/kunwar-shah/claudex) ⭐ 94 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-20** – Open-source MCP server giving Claude Code persistent memory and FTS5 full-text search across conversation history.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,256 | 🐛 1,365 | 📅 2025-12-31** – General AI tools for various applications.
* **[Awesome Vibe Coding](https://github.com/ai-for-developers/awesome-vibe-coding) ⭐ 839 | 🐛 98 | 🌐 HTML | 📅 2026-08-13** – Tools and resources for vibe coding.
