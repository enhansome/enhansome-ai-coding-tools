...
> Contributions welcome – [Open a PR](https://github.com/ai-for-developers/awesome-ai-coding-tools/pulls) ⭐ 2,051 | 🐛 353 | 📅 2026-04-25.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,822 | 🐛 849 | 🌐 TypeScript | 📅 2026-09-05** – Google's terminal coding agent powered by Gemini.
* **[Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,246 | 🐛 1 | 🌐 Rust | 📅 2026-09-05** – Open-source agent that runs code locally in response to natural language, supporting Python, JS, shell, and more.
* **[Cline (Claude Dev)](https://github.com/cline/cline) ⭐ 67,523 | 🐛 1,250 | 🌐 TypeScript | 📅 2026-09-05** – VS Code extension with full file system access and autonomous coding.
* **[AutoGen](https://github.com/microsoft/autogen) ⭐ 60,821 | 🐛 1,048 | 🌐 Python | 📅 2026-04-15** – Microsoft's multi-agent framework for building AI agent teams that collaborate on coding tasks.
...
* **[Codename Goose](https://github.com/block/goose) ⭐ 53,940 | 🐛 304 | 🌐 Rust | 📅 2026-09-05** – Desktop and CLI agent by Block for automating tasks using LLMs and extensions.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,774 | 🐛 1,853 | 🌐 Python | 📅 2026-05-22** – AI coding agent for collaborative editing and code generation via CLI.
* **[SWE-agent](https://github.com/princeton-nlp/SWE-agent) ⭐ 20,239 | 🐛 98 | 🌐 Python | 📅 2026-08-31** – Princeton's autonomous agent that resolves real GitHub issues by navigating repos, editing files, and running tests.
...
* **[PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,021 | 🐛 73 | 🌐 Python | 📅 2026-09-05** – Multi-agent framework with 100+ LLM support and MCP integration.
* **[SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 662 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-30** – Self-hosted multi-agent runtime with MCP client and server support, 23+ LLM providers, persistent memory, skills, schedules, and messaging connectors. Electron desktop app, CLI, and Docker.
...
* **[Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,822 | 🐛 849 | 🌐 TypeScript | 📅 2026-09-05** – Google's open-source terminal coding agent with free Gemini 3 Pro access and 1M token context.
* **[Aider](https://github.com/paul-gauthier/aider) ⭐ 48,774 | 🐛 1,853 | 🌐 Python | 📅 2026-05-22** – Open-source terminal AI pair programmer with deep git integration; every AI edit is auto-committed.
* **[GitHub Copilot CLI](https://github.com/cli/cli/tree/trunk/pkg/cmd/copilot) ⭐ 46,161 | 🐛 1,075 | 🌐 Go | 📅 2026-09-05** – GitHub's AI assistant for command-line with context-aware suggestions.
...
* **[Screenshot-to-Code](https://github.com/abi/screenshot-to-code) ⭐ 77,882 | 🐛 142 | 🌐 Python | 📅 2026-08-14** – Convert screenshots and designs into clean HTML/React/Vue code using AI.
...
* **[CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,211 | 🐛 310 | 🌐 TypeScript | 📅 2026-09-05** – Open-source framework for building custom AI copilots, chatbots, and text areas into React apps.
...
* **[Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,867 | 🐛 83 | 🌐 Python | 📅 2026-09-05** – Open-source AI agent for PR reviews with actionable insights.
...
* **[Repowise](https://github.com/repowise-dev/repowise) ⭐ 6,340 | 🐛 162 | 🌐 Python | 📅 2026-09-05** - Open-source codebase intelligence tool that indexes repos into dependency graphs, git history, auto-generated docs, and architectural decisions via 7 MCP tools.
...
* **[Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) ⭐ 16,829 | 🐛 112 | 🌐 Python | 📅 2026-03-24** – Alibaba's open-source coding model, leading choice for self-hosted/local deployment in 2026.
...
* **[Task Master](https://github.com/eyaltoledano/claude-task-master) ⭐ 28,054 | 🐛 212 | 🌐 JavaScript | 📅 2026-04-28** – AI-driven task management for development with Claude, designed for Cursor.

* **[toprank](https://github.com/nowork-studio/toprank) ⭐ 3,466 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-05** – Open-source (MIT) Claude Code plugin with 9 SEO and Google Ads skills. Connects Google Search Console, PageSpeed Insights, and the Google Ads API to audit traffic, ship meta tag and schema markup fixes, and manage ad campaigns directly from Claude Code.
...
* **[git-parsec](https://github.com/erishforG/git-parsec) ⭐ 15 | 🐛 10 | 🌐 Rust | 📅 2026-09-05** – Git worktree lifecycle manager that gives each AI agent an isolated workspace tied to issue tickets (Jira, GitHub Issues, GitLab), avoiding index.lock conflicts in parallel workflows.
...
* **[LiteLLM](https://github.com/BerriAI/litellm) ⭐ 58,115 | 🐛 4,892 | 🌐 Python | 📅 2026-09-05** – Unified API proxy for 100+ LLM providers with load balancing, spend tracking, and rate limiting.
* **[Semantic Kernel](https://github.com/microsoft/semantic-kernel) ⭐ 28,537 | 🐛 282 | 🌐 C# | 📅 2026-09-04** – Microsoft's SDK for integrating LLMs into C#, Python, and Java applications.
* **[Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,844 | 🐛 577 | 🌐 TypeScript | 📅 2026-09-05** – Open-source tool for testing, evaluating, and red-teaming LLM prompts and applications.
...
* **[llamafile](https://github.com/Mozilla-Ocho/llamafile) ⭐ 25,879 | 🐛 215 | 🌐 C++ | 📅 2026-09-03** – Mozilla project that packages LLMs into single executable files that run anywhere.
...
* **[Awesome AI Tools](https://github.com/mahseema/awesome-ai-tools) ⭐ 6,129 | 🐛 1,291 | 📅 2025-12-31** – General AI tools for various applications.
